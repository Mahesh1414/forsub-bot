...
class Config():
  ...
  if ENV:
    ...
    BOT_TOKEN = "1979818055:AAFh8BenfeGWcgk5QaWgokTjbCPihT9X9ws"
    DATABASE_URL = ""
    APP_ID = "7903343"
...
class Messages():
      HELP_MSG = [
        ...
        "**Developed by BRYLL CODERS**\n\nPowered by @bryllbots\nThanks to - BRYLL CODERS"
      ]

      START_MSG = "Hey [{}](tg://user?id={})\nI am a multifunctional group manager bot from @bryllbots.\nLearn more at /help"
